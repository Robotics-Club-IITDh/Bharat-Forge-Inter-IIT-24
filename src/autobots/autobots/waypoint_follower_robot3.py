...
class WaypointFollower(Node):
    def __init__(self):
        super().__init__('waypoint_follower_robot3')
        
        # Waypoints in world coordinates
        self.waypoints = [
            (25.860, -14.543),   # First waypoint (spawn point)
            (21.486, -14.314),   # Second waypoint
            (23.623, -17.794),   # Third waypoint
            (21.106, -21.313),   # Fourth waypoint
            (25.818, -20.446),   # Fifth waypoint
            (25.860, -14.543)    # Back to start
        ]
        ...
        self.cmd_vel_pub = self.create_publisher(
            Twist,
            '/robot_3/cmd_vel',  # Updated topic for robot_3
            10
        )
        
        self.odom_sub = self.create_subscription(
            Odometry,
            '/robot_3/odom',    # Updated topic for robot_3
            self.odom_callback,
            10
        )
        ...
        self.get_logger().info('Robot 3 waypoint follower initialized')
